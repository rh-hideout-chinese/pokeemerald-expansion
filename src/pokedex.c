...
static const u8 sText_UnkHeight[] = _("{CLEAR_TO 12}???.?m");
static const u8 sText_UnkHeightMetric[] = _("???.? m");
static const u8 sText_UnkWeight[] = _("???.?kg");
static const u8 sText_UnkWeightMetric[] = _("???.? kg.");
static const u8 sText_PokedexRegistration[] = _("图鉴登记完毕。");
static const u8 sText_HTHeight[] = _("身高");
static const u8 sText_WTWeight[] = _("体重");
static const u8 sText_SearchingPleaseWait[] = _("搜索中……\n请稍候。");
static const u8 sText_SearchCompleted[] = _("搜索完毕。");
static const u8 sText_NoMatchingPkmnWereFound[] = _("没有找到符合条件的宝可梦。");
static const u8 sText_SearchForPkmnBasedOnParameters[] = _("搜索宝可梦\n请选择条件。");
static const u8 sText_SwitchPokedexListings[] = _("切换图鉴的排列方式。");
static const u8 sText_ReturnToPokedex[] = _("返回图鉴。");
static const u8 sText_SelectPokedexMode[] = _("选择图鉴的模式。");
static const u8 sText_SelectPokedexListingMode[] = _("选择图鉴的排列模式。");
static const u8 sText_ListByFirstLetter[] = _("按名字的首字母排列。\n仅限已发现的宝可梦。");
static const u8 sText_ListByBodyColor[] = _("按身体颜色排列。\n仅限已发现的宝可梦。");
static const u8 sText_ListByType[] = _("按属性排列。\n仅限已捕捉的宝可梦。");
static const u8 sText_ExecuteSearchSwitch[] = _("执行搜索或切换。");
...
{
    [DEX_MODE_HOENN]    = {COMPOUND_STRING("丰缘地区的图鉴"),   COMPOUND_STRING("丰缘图鉴")},
    [DEX_MODE_NATIONAL] = {COMPOUND_STRING("全国版本的图鉴"), COMPOUND_STRING("全国图鉴")},
    {},
};

static const struct SearchOptionText sDexOrderOptions[] =
{
    [ORDER_NUMERICAL]    = {COMPOUND_STRING("按图鉴的编号来\n排列宝可梦。"),      COMPOUND_STRING("编号模式")},
    [ORDER_ALPHABETICAL] = {COMPOUND_STRING("按字母顺序排列\n已发现的宝可梦。"),   COMPOUND_STRING("拼音模式")},
    [ORDER_HEAVIEST]     = {COMPOUND_STRING("从最重到最轻排列\n已捕捉的宝可梦。"), COMPOUND_STRING("体重降序模式")},
    [ORDER_LIGHTEST]     = {COMPOUND_STRING("从最轻到最重排列\n已捕捉的宝可梦。"), COMPOUND_STRING("体重升序模式")},
    [ORDER_TALLEST]      = {COMPOUND_STRING("从最高到最低排列\n已捕捉的宝可梦。"),  COMPOUND_STRING("身高降序模式")},
    [ORDER_SMALLEST]     = {COMPOUND_STRING("从最小到最大排列\n已捕捉的宝可梦。"),  COMPOUND_STRING("身高升序模式")},
    {},
};
...
{
    {sText_DexEmptyString, sText_DexSearchDontSpecify},
    [BODY_COLOR_RED + 1]    = {sText_DexEmptyString, COMPOUND_STRING("红")},
    [BODY_COLOR_BLUE + 1]   = {sText_DexEmptyString, COMPOUND_STRING("蓝")},
    [BODY_COLOR_YELLOW + 1] = {sText_DexEmptyString, COMPOUND_STRING("黄")},
    [BODY_COLOR_GREEN + 1]  = {sText_DexEmptyString, COMPOUND_STRING("绿")},
    [BODY_COLOR_BLACK + 1]  = {sText_DexEmptyString, COMPOUND_STRING("黑")},
    [BODY_COLOR_BROWN + 1]  = {sText_DexEmptyString, COMPOUND_STRING("棕")},
    [BODY_COLOR_PURPLE + 1] = {sText_DexEmptyString, COMPOUND_STRING("紫")},
    [BODY_COLOR_GRAY + 1]   = {sText_DexEmptyString, COMPOUND_STRING("灰")},
    [BODY_COLOR_WHITE + 1]  = {sText_DexEmptyString, COMPOUND_STRING("白")},
    [BODY_COLOR_PINK + 1]   = {sText_DexEmptyString, COMPOUND_STRING("粉")},
    {},
};
...
static void PrintMonName(u8 windowId, u8 fontId, const u8 *str, u8 left, u8 top)
{
    ...
    //修改，修改精灵名字显示
    AddTextPrinterParameterized4(windowId, fontId, (left * 8) - 2 - xOffset, (top * 8) + 1, 0, 0, color, TEXT_SKIP_DRAW, str);
}
...
void ClearMonListEntry(u8 x, u8 y, u16 unused)
{
    ...
    FillWindowPixelRect(0, PIXEL_FILL(0), x * xMultiplier, y * 8, 0x62, 16);
}
