...
{
    { COMPOUND_STRING("设置固定大量出现"), DebugAction_Outbreak_SetStatic },
    { COMPOUND_STRING("清除当前大量出现"), DebugAction_Outbreak_ClearActive },
    { COMPOUND_STRING("宝可梦: {STR_VAR_1}"), DebugAction_Outbreak_SetSpecies },
    { COMPOUND_STRING("地图: {STR_VAR_1}"), DebugAction_Outbreak_SetMap },
    { COMPOUND_STRING("等级: {STR_VAR_1}"), DebugAction_Outbreak_SetLevel },
    { COMPOUND_STRING("招式"), DebugAction_Outbreak_SetMoves },
    { COMPOUND_STRING("概率: {STR_VAR_1}"), DebugAction_Outbreak_SetProbability },
    { COMPOUND_STRING("剩余天数: {STR_VAR_1}"), DebugAction_Outbreak_SetDaysLeft },
    { COMPOUND_STRING("设置动态大量出现"), DebugAction_Outbreak_SetDynamic },
    { NULL }
};
