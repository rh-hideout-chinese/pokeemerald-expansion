...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_HITXTIMES]                            = COMPOUND_STRING("击中了{B_BUFF1}次{B_BUFF2}！"), 
    ...
    [STRINGID_FRISKACTIVATES]                       = COMPOUND_STRING("察觉到了{B_SCR_NAME_WITH_PREFIX}的\n{B_LAST_ITEM}！"),
