...
{
#if IS_FRLG
    static const u8 sText_PlayerMale[] = _("赤红");
    static const u8 sText_PlayerFemale[] = _("叶子");
    static const u8 sText_Rival[] = _("青绿");
#else
    static const u8 sText_PlayerMale[] = _("小悠");
    static const u8 sText_PlayerFemale[] = _("小遥");
#endif  // IS_FRLG
