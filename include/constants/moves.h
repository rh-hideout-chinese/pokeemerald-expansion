...
enum Z_MOVES
{
	MOVE_BREAKNECK_BLITZ = MOVES_COUNT,
...
#define FIRST_Z_MOVE MOVES_COUNT
#define LAST_Z_MOVE  MOVES_COUNT_Z - 1
#define FIRST_MAX_MOVE MOVES_COUNT_Z
#define LAST_MAX_MOVE  MOVES_COUNT_DYNAMAX - 1
